function Footer() {
  return (
    <section className="py-3 bg-white ">
      <div className="px-4 mx-auto  sm:px-6 lg:px-8 max-w-7xl mb-0">
        <div className="text-center  xl:flex xl:items-center xl:justify-between xl:text-left">
          ...
          <div className="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
            ...
            <div className="w-full h-px mt-8 mb-5 xl:w-px xl:m-0 xl:h-6 text-gray-50/20"></div>
            ...
            <ul className="flex items-center justify-center space-x-8 xl:justify-end">
              <li>
                <a
                  href="#"
                  title=""
                  className="block text-[#2d2e32] transition-all duration-200  hover:text-yellow-600/90 focus:text-opacity-80"
                >
                  <svg
                    className="w-6 h-6"
